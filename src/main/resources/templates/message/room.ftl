...
<div class="container" id="app" v-cloak>
    <div class="header d-flex justify-content-between align-items-center">
        <h3>채팅방 목록</h3>
        <a class="btn btn-primary btn-sm" href="http://localhost:3000">홈으로</a>
    </div>
    ...
    <!-- 채팅방 목록 -->
    <div v-for="item in chatrooms" v-bind:key="item.chatRoomId" class="chatroom-card"
         @click="enterRoom(item.chatRoomId, item.memberId)">
...
<script>
    ...
    var vm = new Vue({
        ...
        data: {
            room_name: '',
            chatrooms: [],
            token: 'eyJhbGciOiJIUzI1NiJ9.eyJjYXRlZ29yeSI6ImFjY2VzcyIsImVtYWlsIjoiZG9tMTA0NjJAZ21haWwuY29tIiwicm9sZSI6IlJPTEVfVVNFUiIsImlhdCI6MTcyODAyMTUxNCwiZXhwIjoxNzI4MDIyMTE0fQ.fPtHH9hmCWlewTaEGDf-qUvnUt7Z8Xvaig-qpnNb0IY'
        },
        //페이지 시작시 실행 메서드
        created() {
            this.findAllRoom();
